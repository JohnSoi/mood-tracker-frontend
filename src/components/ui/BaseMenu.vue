    ...
    <div class="BaseMenu__wrapper flex flex-column p-xs full-size-h box-shadow">
        ...
        <div class="BaseMenu__footer flex-center flex flex-column">
            ...
            >
                <i
                    class="fa-solid"
                    :class="'fa-chevron-' + (menuState.collapsed ? 'right' : 'left')"
                ></i>
            ...
            <div
                ...
                :title="
                    appState.darkThemeEnable() ? 'Включить светлую тему' : 'Включить темную тему'
                "
                :class="{
                    'mb-sm':
                        !authState.userAuthenticate && isWidthGreaterThan(WIDTH_FOR_COLLAPSE_MENU),
                    'mr-md':
                        !authState.userAuthenticate && !isWidthGreaterThan(WIDTH_FOR_COLLAPSE_MENU),
